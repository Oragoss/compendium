...
export default class AddPhoto extends Component {
    ...
    render() {
       let {hasPhoto} = this.state;

        return(
            // TODO: Change this to look more like a meta tag form
            <div className="container">
                <div className="row" style={{marginTop: "10%"}}>
                     {hasPhoto ? "Display photo" : <Card src="./images/stock-img.svg" title="Add photo" text="Add a new photo to a new or existing collection" buttonText="+Attach" buttonType="success"/> }

                    {/* TODO: START HERE; STYLE THIS FORM*/}
...
{/*
    ...
    <div className="col-md-6 text-center">
                    <img className="d-block mx-auto mb-4" src="./images/book-orange.svg" alt="" width="72" height="72" />
                    <h2>Checkout form</h2>
